...
The programming language you will be learning is C++, because it used in many video games and in
the Unreal Engine. Both C++ and C# are {\bf high-level languages};
